...
#     def upload(self,bucket,source,destination,overwrite=False):
#         
#         
#         ''' check if key exists'''
#         if bucket.get_key(destination)!=None:
#             print "key already exists"
#             
#             if overwrite==True:
#                 print "overwriting"
#                 key = bucket.new_key(destination)    
...
#         
#         bucket = self.connectBucket("stackoverflow_data")
# 
#         k=0
#         tree = os.walk('data')
#         
...
#                 k+=1
#                 print k
#                 self.upload(bucket,"%s/%s"%(root,f),"stackoverflow/%s/%s"%(root[5:],f))
...
if __name__ == '__main__':
    ...
    global StackOkey
    StackOkey = 'g7kC75ZDMAQ1dLqlpZ7PIA(('
